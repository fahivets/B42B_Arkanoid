...
public:
	...
	AudioManager() = delete;
	AudioManager(const std::string& folder, const std::string& extention);
	~AudioManager();
	...
	void playSound(const std::string& name, const int& loops = 0, const int& channel = -1, const int& volume = 64) const;
	void playMusic(const std::string& name, const int& loops = -1, const int& volume = 64) const;
